...
export const Adddog = () => {
   ...
   const catonly=dog.filter((item)=>item.catogory==="dog-food" ||item.catogory=="dog-treat")
//for edit
...
<div className="flex justify-end mb-8">
  <button className="bg-green-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-green-700 transition-colors duration-200 flex items-center"
 onClick={newproduct}>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-4">
                <p className="text-gray-600 font-semibold">Price: ${prod.price}</p>
              ...
              <div className="flex justify-between space-x-3">
                ...
                <button className="flex-1 bg-red-600 text-white font-semibold py-2 rounded-md hover:bg-red-700 transition-colors duration-200"
